...
L.GridLayer.include({
    ...
    _update: function (center) {
        ...
        if (queue.length !== 0) {
            ...
            // create a DOM fragment to append tiles in one batch
    ...
    _isValidTile: function (coords) {
        ...
        // don't load the tile if it doesn't intersect the bounds in options
    ...
    _setZoomTransform: function (level, center, zoom) {
        ...
        const translate = level.origin
            ...
            .round()
        console.log('browser', Browser, Browser.any3d)
        if (Browser.any3d) {
